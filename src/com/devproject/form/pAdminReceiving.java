 ...
 * @author LC01
 */
public class pAdminReceiving extends javax.swing.JPanel {
    ...
    public pAdminReceiving() {
        initComponents();
       
    }

    public void addActionListenerAdminReceivingback (ActionListener l) {
        btnback.addActionListener(l);
    }

    public void addActionListenerAdminReceivingrefresh (ActionListener l) {
        btnrefresh.addActionListener(l);
    }
    
    public void addActionListenerAdminReceivingsearch (ActionListener l) {
        btnsearch.addActionListener(l);
    }
    
    public void addKeyListenerAdminreceivingSearch (KeyListener l) {
        txtsearch.addKeyListener(l);
    }
    
    public void addActionListenerAdminReceivingtabel (MouseListener l) {
         tabelreceiving.addMouseListener(l);
    }

    public JTable getTabelAdminreceiving() {
